    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 m-auto border my-5 border-warning shadow font-monospace">
                ...
                <div class="py-3">
                    <p class="text-center fw-bold fs-3 text-warning ">Login page</p>
                </div>
                ...
                <form action="login1.php" method="post">
                    ...
                    <div class="mb-3 col-12">
                        <button type="submit" name="save" class="btn btn-danger py-2 w-100 fw-bold fs-4">Login</button>
                    </div>

                    <div class="mb-3 col-12">
                        <a href="register.php" class="btn btn-warning  w-100 fw-bold fs-4 py-2 text-white">Create new account</a>
                    </div>
